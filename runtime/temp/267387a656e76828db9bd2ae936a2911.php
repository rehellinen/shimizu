<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"C:\wamp\www\shimizu\public/../application/admin\view\news\add.html";i:1508323688;s:71:"C:\wamp\www\shimizu\public/../application/admin\view\public\header.html";i:1508053983;s:68:"C:\wamp\www\shimizu\public/../application/admin\view\public\nav.html";i:1508082507;s:71:"C:\wamp\www\shimizu\public/../application/admin\view\public\footer.html";i:1508127408;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <form class="form-horizontal" id="submitForm" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="editor_id" class="col-sm-2 control-label">介绍：</label>
                    <div class="col-sm-10">
                        <textarea class="input js-editor" id="editor_id" name="content" rows="20"></textarea>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    var URL = {
        'submit_url' : '__PATH__?s=admin/news/add',
...
<script charset="utf-8" src="__STATIC__/vendor/kindeditor/kindeditor-all-min.js"></script>
<script charset="utf-8" src="__STATIC__/vendor/kindeditor/lang/zh-CN.js"></script>
<script>
    KindEditor.ready(function(K) {
        window.editor = K.create('#editor_id', {
            uploadJson : '__PATH__?s=admin/image/editor',
            fieldName : 'imgFile'
        });
    });
</script>
