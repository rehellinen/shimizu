<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"C:\wamp\www\shimizu\public/../application/admin\view\menu\edit.html";i:1508086106;s:71:"C:\wamp\www\shimizu\public/../application/admin\view\public\header.html";i:1508053983;s:68:"C:\wamp\www\shimizu\public/../application/admin\view\public\nav.html";i:1508082507;s:71:"C:\wamp\www\shimizu\public/../application/admin\view\public\footer.html";i:1508127408;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
            <form class="form-horizontal" id="submitForm" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="m" id="m" value="<?php echo $res['m']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="c" id="c" value="<?php echo $res['c']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="f" id="f" value="<?php echo $res['f']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" name="type" value="2" <?php echo $res['type']==2?'checked' : ''; ?>>前端导航
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="type" value="1" <?php echo $res['type']==1?'checked' : ''; ?>>后台菜单
                        </label>
                    </div>
                </div>
...
<script>
    var URL = {
        'submit_url' : '__PATH__?s=admin/menu/edit',
