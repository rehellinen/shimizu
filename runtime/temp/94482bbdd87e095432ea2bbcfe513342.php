<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"C:\wamp\www\shimizu\public/../application/index\view\news\index.html";i:1520597295;s:71:"C:\wamp\www\shimizu\public/../application/index\view\public\header.html";i:1520595667;s:68:"C:\wamp\www\shimizu\public/../application/index\view\public\nav.html";i:1521001832;s:71:"C:\wamp\www\shimizu\public/../application/index\view\public\footer.html";i:1520598373;}*/ ?>
...
<link rel="stylesheet" href="__STATIC__/index/css/news.css" type="text/css" media="all" />
<!-- headLogo -->
...
<!-- 门店装饰 -->
<div class="col-md-12 decoration"></div>
    
    <!-- 资讯 -->
    <div class="body">
        <?php if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): $key = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
        <div class="news col-md-12 col-sm-12">
            <div class="col-md-3">
