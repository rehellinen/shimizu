<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"C:\wamp\www\shimizu\public/../application/admin\view\media\edit.html";i:1508321926;s:71:"C:\wamp\www\shimizu\public/../application/admin\view\public\header.html";i:1508053983;s:68:"C:\wamp\www\shimizu\public/../application/admin\view\public\nav.html";i:1508082507;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <form class="form-horizontal" id="submitForm" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img id="upload_org_code_video" src="<?php echo $res['url']; ?>" width="150" height="150">
                        <input id="file_upload_video" name="url" type="hidden" multiple="true" value="">
                    </div>
                </div>
...
<script>
    var URL = {
        'submit_url' : '__PATH__?s=admin/media/edit',
        'success_url' : '__PATH__?s=admin/media/index',
        'swf_url' : '__STATIC__/vendor/uploadify/uploadify.swf',
        'video_url' : '__PATH__?s=admin/image/video'
    }
</script>
<!-- jQuery -->
...
<script src="__STATIC__/vendor/admin/video.js"></script>
